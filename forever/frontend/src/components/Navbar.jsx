...
const Navbar = () => {
    ...
    return (
        <div className='navbar-container text-white'>
            <div className='flex items-center justify-between py-5 font-medium max-w-screen-xl px-0'>
            ...
            <div className='flex items-center gap-4 ml-[-70px]'>
                ...
                <NavLink to='/login' className='flex flex-col items-center gap-1 text-white mr-[-70px]'>
                        <p>LOGIN</p>
                        <hr className='w-2/4 border-none h-[1.5px]' />
                    </NavLink>
                <div className='flex items-center gap-6 mr-[-70px]'>
